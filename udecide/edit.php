...
<html>
    ...
    <body>
        ...
        <div class="container" style="width: 600px;">
            <form class="form-horizontal" method="post" onsubmit="return validate_form(this)" action="cEditUpdate.php" style="margin-top: 40px; margin-bottom: 90px;" enctype="multipart/form-data">
        ...
        <script type="text/javascript">
            var obj=<?php echo json_encode($SurveyEdit); ?>;
