...
<body>
    ...
    <table id="disptable" style="width: 800px;">
    <tr>
    <td><p class="lead" style="width: 250px;">Survey Name</p></td>
    <td><p class="lead" style="width: 80px;">id</p></td>
    <td><p class="lead" style="width: 230px;">Posted on</p></td>
    <td><p class="lead" style="width: 240px;">Number of Responses</p></td>
    </tr>
    </table>
    <script type="text/javascript">
		...
		"<tr><td><a href='result.php?id=" + obj[i].id +"'><p class='lead'><u>" + obj[i].name + "</u></p></a></td><td><p class='lead'>" + obj[i].id + "</p></td><td><p class='lead'>" + obj[i].date + "</p></td><td><p class='lead'>" + obj[i].total + "</p></td></tr>";
		}
	</script>
    </div>
    </div>
