                        ...
                        <div class="container">
                            ...
                            <div style="width: 870px;">
                                ...
                                <script type="text/javascript">
                                    var obj=<?php echo json_encode($survey); ?>;
                                    //console.log(obj);
                                    var isEmpty = function(obj) {
                                        return obj=='';                                             
                                    }
                                    if (isEmpty(obj)) {
                                        document.getElementById('tablebody').innerHTML +="<tr class='selectable'><td colspan=\"4\"><p class='lead' style='color: #0088cc;text-align: center'>" +"No survey has been created"+ "</p></a></td></tr>";                                          
                                    }
                                    else {
